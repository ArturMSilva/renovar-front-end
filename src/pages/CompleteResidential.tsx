...
export const CompleteResidential = () => {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.residentsCount.trim()) {
      ...
      newErrors.residentsCount = 'Deve haver pelo menos 1 morador';
    }
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#1A1F36]">Complete seu Cadastro</h1>
              <p className="text-base text-[#4A5568]">Residência</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-[#F3F4F6] p-4 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <Input
                  ...
                  onChange={(e) => handleChange('residentsCount', e.target.value)}
                  icon={<Users size={20} className='text-[#10B981]'/>}
                  error={errors.residentsCount}
                  min="1"
                />
              </div>
            </div>
            ...
            <div className="bg-[#F3F4F6] p-4 rounded-lg">
              <h2 className="text-lg font-bold text-[#1A1F36] mb-4">Endereço</h2>
